                            ...
                            <div className="caption">
                                ...
                                {product.rating ?
                                    <div className="rating">
                                        {[1, 2, 3, 4, 5].map(i => {
                                            if (product.rating < i) return <span className="fa fa-stack"><i className="fa fa-star-o fa-stack-2x"></i></span>
                                            else return <span className="fa fa-stack"><i className="fa fa-star fa-stack-2x"></i><i className="fa fa-star-o fa-stack-2x"></i></span>
                                        })}
                                    </div>
                                    : ''}
                                {product.price ?
